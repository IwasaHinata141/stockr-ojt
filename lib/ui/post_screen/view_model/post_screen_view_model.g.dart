...
part of 'post_screen_view_model.dart';
...
@ProviderFor(TextStateNotifier)
final textStateNotifierProvider =
    AutoDisposeNotifierProvider<TextStateNotifier, String>.internal(
  TextStateNotifier.new,
  name: r'textStateNotifierProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$textStateNotifierHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
